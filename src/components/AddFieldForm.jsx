...
export default function AddFieldForm({
    ...
    const resetForm = () => {
        ...
        handleFieldTypeChange({ value: 'text', text: 'Texto' });
        ...
        setFieldOptionRows([]);
        setFieldType(FIELD_TYPES.text.fieldType);
        setSetupAvailable(FIELD_TYPES.text.setupAvailable);
        handleLabelChange('');
    ...
    return (
        <MDBRow>
            <MDBCol className='text-center my-4'>
                <MDBBtn onClick={toggleShowAddModal}>Agregar Campo</MDBBtn>
                <MDBModal show={addFieldModal} setShow={setAddFieldModal} tabIndex='-1'>
                    <MDBModalDialog size='xl'>
                        <MDBModalContent>
                            <form onSubmit={handleSubmit}>
                                <MDBModalHeader>
                                    <MDBModalTitle>Agregar Campo</MDBModalTitle>
                                    <MDBBtn className='btn-close' color='none' onClick={toggleShowAddModal}></MDBBtn>
                                </MDBModalHeader>
                                <MDBModalBody>
                                ...
                                <MDBModalFooter>
                                    <MDBBtn color='secondary' type='button' onClick={toggleShowAddModal}>
                                        Volver
                                    </MDBBtn>
